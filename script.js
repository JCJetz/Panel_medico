document.addEventListener('DOMContentLoaded', function() {
    ...
    noResults.className = 'no-results';//le doy la clase no-results
    noResults.style.display = 'none';//lo oculto
    ...
    // funcionalidad para Nuevos Pacientes
    ...
    function getNextPatientId() {
        ...
        let maxId = 0;//inicializo el id en 0
        ...
        return String(maxId + 1).padStart(3, '0');//devuelvo el id del paciente
    }
